...
def _annotation_item(seq):
    symbol = seq.parse(identifier_token_a)
...
_class_name_ptn = u'({0})({1})*'.format(_name_start, _name_char)
_class_name_token_ptn = u'{0}(\\+({1})?)?'.format(_class_name_ptn, _class_name_ptn)
