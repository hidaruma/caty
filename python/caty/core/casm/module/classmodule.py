...
class ClassExprInterpreter(object):
    ...
    def visit_class_ref(self, obj):
        ...
        COLLECTION_COMMANDS = set([u'lookup', u'get', u'belongs', u'exists', u'keys', u'all', u'insert', u'replace', u'delete', u'count', u'dump', u'delete-all', u'list', u'mget', u'multi-get', u'next-index', u'poke', u'set', u'grep'])
        try:
