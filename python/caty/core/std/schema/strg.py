...
command drop-collection [string] :: void -> void
    updates storage
    refers python:caty.core.std.command.strg.DropCollection;
...
command list-collections :: void -> [Collection*]
    reads storage
    refers python:caty.core.std.command.strg.List;
...
command select<T default object> {
    ...
    reads storage
    refers python:caty.core.std.command.strg.Select;
...
command update [string] :: [any, any] -> null
    updates storage
    refers python:caty.core.std.command.strg.Update;
...
command delete [string] :: any -> null
    updates storage
    refers python:caty.core.std.command.strg.Delete;
...
command dump 
    ...
    reads storage
    refers python:caty.core.std.command.strg.Dump;
...
command restore :: DumpInfo -> void
    uses storage
    refers python:caty.core.std.command.strg.Restore;
"""
