...
def _script_actions(module):
    ...
    r = DefaultResource('**.cgi|**.act|**.do', actions, rbody._module_name, rbody.rcname, rbody.docstring, rbody.annotations)
...
def _dir_actions(module):
    ...
    r = DefaultResource('**/|/', actions, rbody._module_name, rbody.rcname, rbody.docstring, rbody.annotations)
    module.add_resource(r)
...
def _template_actions(module):
    ...
    r = DefaultResource('**.html|**.xhtml|**.xml|**.htm', actions, rbody._module_name, rbody.rcname, rbody.docstring, rbody.annotations)
    module.add_resource(r)
